...
from pyspark.sql.functions import col, unix_timestamp, expr, current_timestamp
...
# Sélection des colonnes souhaitées pour l'insertion dans Cassandra
...
# Fonction pour insérer ou mettre à jour les données dans Cassandra
